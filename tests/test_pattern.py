...
class TestPatternMatching:
    def test_exact_match(self):
        result = match(5, case(5, lambda x: "five"), case(10, lambda x: "ten"))
        assert result == "five"

    def test_wildcard_match(self):
        result = match(100, case(5, lambda x: "five"), case(_, lambda x: "other"))
        assert result == "other"

    def test_type_match(self):
        result = match("hello", case(int, lambda x: "integer"), case(str, lambda x: "string"))
    ...
    def test_no_match_raises(self):
        with pytest.raises(ValueError):
            match(100, case(1, lambda x: "one"), case(2, lambda x: "two"))
    ...
    def test_custom_type_matching(self):
        ...
        result = match(Dog(), case(Dog, lambda x: "woof"), case(Cat, lambda x: "meow"))
        assert result == "woof"
